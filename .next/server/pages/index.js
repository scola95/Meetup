...
const getStaticProps = async () => {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Gabriele:9qZkManW5Oi89CkC@cluster0.8kspf.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
